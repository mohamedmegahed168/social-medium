...
function Hero() {
  return (
    <motion.main className="mt-16 w-full bg-[#f7f4ed]">
      <motion.div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="text-black px-6 md:px-10 py-12 md:py-16 font-normal">
          ...
          <p className="mt-6 text-lg md:text-xl text-black/75 max-w-lg">
            Discover stories thinking and experties.
            <span className="block"> From writers of any topic. </span>
            Rediscover the are or reading.
          </p>
          <motion.button
            whileHover={{ scale: 1.02 }}
            className="mt-6 inline-flex items-center gap-2 border border-black text-black bg-transparent px-4 py-2 rounded-lg cursor-pointer hover:bg-black hover:text-white transition-colors"
          >
            Start reading
          </motion.button>
        </div>
